  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M19.321 5.562a5.124 5.124 0 0 1-2.15-2.15h-3.562v13.892a2.352 2.352 0 0 1-4.703 0 2.352 2.352 0 0 1 2.703-2.326V10.83a6.4 6.4 0 1 0 6.375 6.375V9.73a8.518 8.518 0 0 0 4.703 1.484V7.653a5.124 5.124 0 0 1-3.366-2.091z" fill="#000"/>
      </svg>
    )
  }
];
